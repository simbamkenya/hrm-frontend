...
import { updateProject, add } from '../store/features/projects'

// import add from '../store/features/projects'
import axios from 'axios'

function AddProjectForm({ onClose, isVisible, selectedProject }) {
  ...
  const handleUpdate = async (e) => {
    console.log('updatefun', projectData)
    e.preventDefault()
    dispatch(
      updateProject({
        ...
        method: 'put',
        data: projectData,
        onSuccess: 'projects/updateProject',
    ...
    try {
      await axios.put(
        `http://localhost:3000/projects/${projectData._id}`,
        projectData
      )
    } catch (e) {
      console.error(e)
