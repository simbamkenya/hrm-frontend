...
import { add } from '../store/features/employees';
...
//     //     onSuccess: 'employees/fetchEmployee',
//     // }))
//   }
  ...
  return (
    <div style={{ visibility:  !isVisible ? "hidden" : "visible"}} className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">       
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" onClick={closeModal}  class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="defaultModal">
            ...
            <form onSubmit={handleSubmit} id="addEmployee" class="w-full max-w-sm">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                    <input  onChange={handleInputChange} value={employeeData.lastName} name="lastName" class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-password" type="text" placeholder="last name"/>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                    <input  onChange={handleInputChange} value={employeeData.email} name="email" class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-password" type="text" placeholder="email"/>
                    </div>
                </div>
